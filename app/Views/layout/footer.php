...
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="<?= base_url() ?>" target="_blank" class="text-dark-75 text-hover-primary">Sistem Monitoring Perpustakaan - By Endang Sulistyowati</a>
        </div>
        <!--end::Copyright-->
    </div>
    <!--end::Container-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $user_login['nama'] ?></a>
                <div class="text-muted mt-1"><?= $user_login['tentang'] ?></div>
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted text-hover-primary"><?= $user_login['email'] ?></span>
                        </span>
                    </a>
...
<script src="<?php echo base_url() ?>/assets/js/custom/myswal.js"></script>
<script src="<?php echo base_url() ?>/assets/js/pages/features/charts/apexcharts.js"></script>
<script src="<?php echo base_url() ?>/assets/js/pages/crud/forms/widgets/bootstrap-datepicker.js?v=7.2.8"></script>
<script>
